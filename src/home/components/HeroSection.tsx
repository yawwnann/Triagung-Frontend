    ...
    >
      ...
      >
        ...
        <button
          ...
          className="bg-blue-500 hover:bg-blue-600 text-white font-semibold px-6 py-3 rounded-full shadow-lg transition flex items-center gap-2 self-center md:self-start cursor-pointer"
          data-aos="zoom-in"
          data-aos-delay="500"
        >
