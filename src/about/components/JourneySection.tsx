...
import { Building, ShoppingCart, Truck, Globe } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-lg text-gray-300 max-w-3xl mx-auto">
            Dari toko lokal hingga menjadi penyedia distribusi berskala luas,
            inilah sejarah perjalanan kami.
          </p>
        </motion.div>
          ...
          <div className="space-y-12 md:space-y-0">
            {[
              ...
              },
              {
                ...
                description:
                  "Menambahkan berbagai kategori produk baru dan mulai merambah ke penjualan berbasis e-commerce.",
              ...
              },
              {
                ...
                description:
                  "Mulai menyediakan layanan pengiriman langsung ke proyek konstruksi berskala besar.",
              ...
              },
              {
                ...
                description:
                  "Mengembangkan platform online untuk kemudahan transaksi dan memperluas jangkauan ke seluruh Pulau Jawa.",
        ...
        >
          ...
          <p className="text-gray-300">
            ...
            berskala luas. Perjalanan ini bukan hanya tentang angka penjualan,
            tetapi tentang membangun kepercayaan.
          </p>
        </motion.div>
      </div>
    </section>
