      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center py-16 px-4 md:px-10 max-w-7xl mx-auto">
        ...
        >
          ...
          <motion.p
            ...
            viewport={{ once: true }}
          >
            Trijaya Agung Material adalah perusahaan yang bergerak di bidang
            distribusi bahan bangunan sejak tahun 2017. Kami berkomitmen
            menyediakan produk berkualitas tinggi seperti semen, pasir, cat, dan
            perlengkapan konstruksi lainnya. Dengan pengalaman bertahun-tahun
            dan jaringan yang luas, kami menjadi mitra terpercaya bagi
            kontraktor, tukang, dan pemilik rumah di seluruh Indonesia.
          </motion.p>
